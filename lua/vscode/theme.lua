...
theme.set_highlights = function(opts)
    ...
    hl(0, '@constant', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@constant.builtin', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_constants })
    hl(0, '@constant.macro', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@string.regex', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@string', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@character', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@number', { fg = c.vscBrightGreen, bg = 'NONE' })
    hl(0, '@boolean', { fg = c.vscBrightOrange, bg = 'NONE' })
    hl(0, '@float', { fg = c.vscBrightGreen, bg = 'NONE' })
    ...
    hl(0, '@field', { fg = c.vscTeal, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscTeal, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@conditional', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@repeat', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@keyword.function', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_function })
    ...
    hl(0, '@variable.builtin', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_letvar })
