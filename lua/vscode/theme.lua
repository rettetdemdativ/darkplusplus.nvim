...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Comment', { fg = c.vscGray, bg = 'NONE' })
    ...
    hl(0, 'Boolean', { fg = c.vscBrightOrange, bg = 'NONE' })
    ...
    hl(0, 'Special', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'TSConstant', { fg = c.vscLightBlue, bg = 'NONE'})
    hl(0, 'TSConstBuiltin', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_constants })
    ...
    hl(0, 'TSNumber', { fg = c.vscBrightGreen, bg = 'NONE' })
    hl(0, 'TSBoolean', { fg = c.vscBrightOrange, bg = 'NONE' })
    hl(0, 'TSFloat', { fg = c.vscBrightGreen, bg = 'NONE' })
    hl(0, 'TSAnnotation', { fg = c.vscGreenTeal, bg = 'NONE' })
    hl(0, 'TSAttribute', { fg = c.vscGreenTeal, bg = 'NONE' })
    hl(0, 'TSNamespace', { fg = c.vscGreenTeal, bg = 'NONE' })
    ...
    hl(0, 'TSField', { fg = c.vscTeal, bg = 'NONE' })
    hl(0, 'TSProperty', { fg = c.vscTeal, bg = 'NONE' })
    hl(0, 'TSConstructor', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'TSConditional', { fg = c.vscPink, bg = 'NONE', italic = opts.italic_conditionals })
    hl(0, 'TSRepeat', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'TSLabel', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'TSKeyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'TSKeywordFunction', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_function })
    ...
    hl(0, 'TSTypeBuiltin', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'TSStructure', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'TSInclude', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'TSVariable', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'TSVariableBuiltin', { fg = c.vscBlue, bg = 'NONE', italic = opts.italic_keyword_letvar })
