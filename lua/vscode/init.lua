...
vscode.setup = function(user_opts)
    ...
    local global_settings_opts = vim.tbl_extend('force', defaults, {
        ...
        italic_conditionals = (vim.g.vscode_italic_conditionals == true
                            or vim.g.vscode_italic_conditionals == 1),
        italic_keyword_letvar = (vim.g.vscode_italic_keyword_letvar == true
                            or vim.g.vscode_italic_keyword_letvar == 1),
